...
export default function footer() {
  return (
    <div className="">
      <footer className="bg-blue-950 text-white py-6  bottom-0 left-0 w-full">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="">
            <h4 className="font-semibold text-gray-400">Socials</h4>
            <ul className="list-none mt-2">
              <li>
                <a href="#" className="hover:text-gray-300 mt-1">
                  Twitter
          ...
          <div className="flex items-center space-x-4 mt-2">
            ...
            <Link to="/temp1" className="text-gray-300 hover:text-white">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M10.5 24V14h-3v10h3zM8.25 11.67C8.25 10.21 7.04 9 5.5 9S2.75 10.21 2.75 11.67v1.67H0v-1.67C0 9.62 2.04 7 5.5 7S11 9.62 11 11.67v1.67h-2.75v-1.67zM19.67 24V14h-3v10h3zM17.42 0H6.58C3 0 0 3 0 6.58v10.83C0 21 3 24 6.58 24h10.83C21 24 24 21 24 17.42V6.58C24 3 21 0 17.42 0zM18 18H6v-2.2c0-1.52 1.2-2.8 2.72-2.8h.56c.4-.4.9-.6 1.42-.6s1.02.2 1.42.6h.56c1.52 0 2.72 1.28 2.72 2.8V18zm0-5c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v1h12v-1z" />
              </svg>
            </Link>
          </div>
        </div>
